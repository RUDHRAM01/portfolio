            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <p>Final-Year Undergraduate Student at Anand International College of Engineering ,Jaipur.</p>
          ...
          <Col xs={12} md={6} xl={5}>
            <TrackVisibility>
              <div className="myimgDiv">
                ...
                <a href="https://drive.google.com/file/d/1bekt2pXzFe7xr3nqPBzRy0vCGqg77AOd/view?usp=sharing" style={{ textDecoration: "none" }} download>
